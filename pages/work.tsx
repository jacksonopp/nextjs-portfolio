    ...
    <>
      ...
      <div className={workStyles.work}>
        <div className={workStyles.work__content}>
          ...
          <p>
            Topaz Design is a set of Angular libraries and customizations on top of Angular Material built for the demands of Pearson VUE's enterprise architecture. It is built with scalibility in
            mind, and includes and recommend a11y best practices so applications can be built for users of all ability in mind.
          </p>
          <p>The framework incorporates user-centric design, and is built to make developing beautiful, robust applications easy for developers.</p>
      ...
      <div className={`${workStyles.work} ${workStyles['work--reverse']}`}>
        <div className={workStyles.work__content}>
          ...
          <p>
            As COVID-19 shut down many of Pearson VUE's test centers, test candidates had to turn to OnVUE, the company's online proctoring service, balooning to over 3M candidates in a year. Because
            of the massive new number of users, a gap in the product's a11y began to become more problematic.
          </p>
          <p>
            I was one of the developers who led the effort to get this product WCAG AA Compliant, as well as change the mentality of a11y being an afterthought to one where it needs to be built in
            from the start.
          </p>
        </div>
        <div className={workStyles.work__img}>
      ...
      <div className={workStyles.work}>
        <div className={workStyles.work__content}>
          ...
          <p className={workStyles.work__role}>
            <span className={workStyles.work__role__title}>Role: </span>Designer & Developer
          </p>
          <p>This is the site you're on right now! It's built in Typescript using Next.js and is deployed on the edge with Vercel.</p>
